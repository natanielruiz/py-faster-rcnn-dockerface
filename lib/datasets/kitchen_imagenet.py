...
class kitchen_imagenet(imdb):
    def __init__(self, image_set, devkit_path):
        ...
        #self._class_to_ind = dict(zip(self.classes, xrange(4, self.num_classes+4)))
        self._class_to_ind = dict(zip(self.classes, xrange(self.num_classes)))
        self._class_to_ind['__background__'] = 0
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'VOCdevkit' + self._<name>tomato)
