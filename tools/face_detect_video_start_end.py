...
def parse_args():
  ...
  parser.add_argument('--start', dest='start_frame', help='Frame number to start detections')
  parser.add_argument('--end', dest='end_frame', help='Frame number to end detections')
...
if __name__ == '__main__':
  ...
  n_frame = 1
  print 'Start frame is: ' + str(args.start_frame)
  print 'End frame is: ' + str(args.end_frame)

  while (int(n_frame) < int(args.start_frame)):
      ret, frame = video.read()
      print 'Skipped frame number: ' + str(n_frame)
      n_frame += 1

  while (int(n_frame) <= int(args.end_frame)):
      ret, frame = video.read()
